...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('transactions.store') }}" method="POST">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="transactionTable">
                                ...
                                <tbody>
                                    <tr class="product-row">
                                        ...
                                        <td class="price text-end">Rp 0</td>
                        ...
                        <button type="button" id="addProduct" class="btn btn-secondary mb-4">+ Tambah Produk</button>
                        <hr>
                        <div class="row">
            ...
            <td>
                <input type="number" name="products[${index}][qty]" class="form-control qty" value="1" min="1" required>
            </td>
            <td class="price text-end">Rp 0</td>
            <td class="subtotal text-end">Rp 0</td>
            <td>
